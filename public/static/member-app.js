...
.<br><span class="text-xs text-gray-500">${pspErr.error||pspErr.message||""}</span></p><button onclick="wizardStep4()" class="py-2 px-6 bg-dark-700 text-gray-300 rounded-xl text-sm"><i class="fas fa-arrow-left mr-1"></i>Retour</button></div>`);}}async function wizardStep5(){const e=_gw,t=_wizardData.paymentMethod,n=_wizardData.totalAmt;_wizardData.orderId=null,_wizardShow('\n  <div class="p-10 flex flex-col items-center gap-4">\n    <div class="loader"></div>\n    <p class="text-gray-400 text-sm">Création de votre commande…</p>\n  </div>');try{let _apiResp;if(_wizardData.isTopup){
